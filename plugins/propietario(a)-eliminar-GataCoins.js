...
handler.command = ['eliminarProyectocoins', 'eliminarProyecto', 'eliminarcoins', 'quitarProyectocoins', 'quitarProyecto', 'quitarcoins', 'delProyectocoins', 'delProyecto', 'delcoins'] 
handler.group = true
handler.rowner = true
